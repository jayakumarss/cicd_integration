 ...
 * Created On  : 2018-08-08 08:13:43
 * Created By  : b.moers
 * Updated On  : 2019-11-25 16:46:02
 * Updated By  : admin
 * URL         : /sys_script_include.do?sys_id=525e2d21db33db0076d6b94ffe9619a6
 */
/**
...
CiCdApi.prototype = /** @lends global.module:sys_script_include.CiCdApi.prototype */ {
	...
	gs.info('Inside Batch Export'+ sysId);
...
gs.info('Inside Single Export'+ sysId);
            response.setStatus(302);

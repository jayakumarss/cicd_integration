 ...
 * Created On  : 2018-11-06 13:24:41
 * Created By  : b.moers
 * Updated On  : 2019-11-20 14:41:17
 * Updated By  : admin
 * URL         : /sys_script_include.do?sys_id=c994922edbe1a700323efc600f9619d6
 */
/* exported CiCdRun */
/* global CiCdApi */
    ...
    sys_update_set_Before_IU: function (current, previous) {
        ...
        if (current.state.changesTo('complete')) {
            try {
                ...
                self.now({
                    updateSet: current.getValue('sys_id'),   
					//updateSet:  updateSetExport.exportHierarchy(current),// the update set to send to the pipeline
                    application: {
